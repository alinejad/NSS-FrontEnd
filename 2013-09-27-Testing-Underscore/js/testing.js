...
test( "Find a String", function() {
  ...
  deepEqual(find_string(strings, "elephant"), "elephant", "should find the string in the array" );
  deepEqual(find_string(strings, "Aardvark"), "Aardvark", "should find the string in the array" );
  deepEqual(find_string(strings, "cat"), "cat", "should find the string in the array" );
});
...
test( "Find a String Ending in a particular letter", function() {
  ...
  deepEqual(find_string_ending_letter(strings, "z"), undefined, "should find the word ending in z" );
});